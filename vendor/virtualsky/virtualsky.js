...
function VirtualSky(input){
	...
	this.langurl = "vendor/virtualsky/lang/%LANG%.json";	// The location of the language files
	...
	this.dir = 'vendor/virtualsky/';  // the JS file path
...
VirtualSky.prototype.createSky = function(){
	...
	this.registerKey(112,function(){ this.toggleHelp(); });
...
VirtualSky.prototype.draw = function(proj){
	...
	this.container.find('.'+this.id+'_clock').css({
		...
		width:metric_clock,
		cursor:'pointer',
		top: (typeof off !== 'undefined') ? off.top+5 : 0,
		left: (typeof off !== 'undefined') ? off.left+5 : 0,
		zIndex:20,
		display:'block',
		overflow:'hidden',
		backgroundColor:'transparent',
	...
	$('.'+this.id+'_position').css({
		...
		width:metric_pos,
		cursor:'pointer',
		top: (typeof off !== 'undefined') ? off.top+5+fontsize : 0,
		left: (typeof off !== 'undefined') ? off.left+5 : 0,
		zIndex:20,
		fontSize:fontsize+'px',
		display:'block',
...
VirtualSky.prototype.setAzimuth = function(inc){
	this.az_off = (typeof inc==="number") ? inc : 0;
	return this;
}
